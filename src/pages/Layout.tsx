    ...
    <div className="layout">
      ...
      <header className={`nav${scrolled ? ' nav--scrolled' : ''}`}>
        <div className="nav__inner container--wide">
          ...
          {/* Desktop links */}
          <nav className="nav__links nav__links--desktop" aria-label="Hauptnavigation">
      ...
      <footer className="footer">
        ...
        <div className="footer__inner container">
          ...
          <p className="footer__location">Wien, Österreich</p>
          <div className="footer__links">
            <a href="mailto:claudiu@dangulea.at" className="footer__link">
              claudiu@dangulea.at
            </a>
